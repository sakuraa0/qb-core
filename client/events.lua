...
RegisterNetEvent('QBCore:Command:GoToMarker', function()
    ...
    if not DoesBlipExist(blipMarker) then
        exports['okokNotify']:Alert('Sistema', Lang:t("error.no_waypoint"), 5000, 'error')
        return 'marker'
    end
    ...
    if not found then
        ...
        exports['okokNotify']:Alert('Sistema', Lang:t("error.tp_error"), 5000, 'error')
    end

    -- If Z coord was found, set coords in found coords.
    SetPedCoordsKeepVehicle(ped, x, y, groundZ)
    exports['okokNotify']:Alert('Sistema', Lang:t("success.teleported_waypoint"), 5000, 'success')
end)
