...
function QBCore.Player.CreateCitizenId()
    ...
    while not UniqueFound do
        CitizenId = math.random(0001, 999999)
...
function QBCore.Functions.CreateAccountNumber()
    ...
    while not UniqueFound do
        AccountNumber = 'PT' .. math.random(1, 9) .. '50' .. math.random(1111, 9999) .. math.random(1111, 9999) .. math.random(11, 99)
...
function QBCore.Functions.CreatePhoneNumber()
    ...
    while not UniqueFound do
        PhoneNumber = math.random(91, 92) .. math.random(100000, 999999)
...
function QBCore.Player.CreateWalletId()
    ...
    local WalletId = nil
    while not UniqueFound do
        WalletId = 'PT' .. math.random(11111111, 99999999)
